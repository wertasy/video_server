...
var (
	...
	ErrorDBError = ErrResponse{HttpSC: 500, Error: Err{Error: "Database options failed.", ErrorCode: "003"}}
	ErrorInternalFaults = ErrResponse{HttpSC: 500, Error: Err{Error: "Internal service failed.", ErrorCode: "004"}}
)